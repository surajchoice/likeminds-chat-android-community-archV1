...
internal class ConversationMultipleDocumentBinder constructor(
    ...
    override fun drawPrimaryColor(binding: ItemConversationMultipleDocumentBinding, color: Int) {
        ...
        binding.tvShowMore.setTextColor(color)
    }
    ...
    override fun drawAdvancedColor(
        ...
        binding.viewSelectionAnimation.backgroundTintList =
            ColorStateList.valueOf(buttonsIconsColor)
        binding.tvShowMore.setTextColor(buttonsIconsColor)
    }
