...
import com.likeminds.chatmm.databinding.ItemConversationDmWidgetBBinding
...
class ConversationDMWidgetBItemViewDataBinder(
    private val userPreferences: UserPreferences,
    private val reactionsPreferences: ReactionsPreferences,
    private val adapterListener: ChatroomDetailAdapterListener
) : ViewDataBinder<ItemConversationDmWidgetBBinding, ConversationViewData>() {
    override val viewType: Int
        get() = ITEM_CUSTOM_WIDGET_B_DM

    override fun createBinder(parent: ViewGroup): ItemConversationDmWidgetBBinding {
        val binding = ItemConversationDmWidgetBBinding.inflate(
    ...
    override fun bindData(
        binding: ItemConversationDmWidgetBBinding,
